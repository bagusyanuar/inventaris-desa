...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Kategori</p>
        ...
        <div class="w-100 p-2">
            <div class="text-right mb-2 pr-3">
                <a href="/kategori/tambah" class="btn btn-primary"><i class="fa fa-plus mr-1"></i><span
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/kategori/edit/{{ $v->id }}" class="btn btn-sm btn-warning btn-edit"
...
@section('js')
    ...
    <script type="text/javascript">
        function destroy(id) {
            AjaxPost('/kategori/delete', {id}, function () {
